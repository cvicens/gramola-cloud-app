...
var EVENTS_COLLECTION_NAME = process.env.EVENTS_COLLECTION_NAME || "live-events";
...
function route() {
  ...
  router.get('/:country/:city/:isoDate', function(req, res) {
    var country = req.params.country;
    var city = req.params.city;
    var isoDate = req.params.isoDate;
    ...
    var filter = {
      "eq": {
        "country": country,
        "city": city,
        "date": isoDate || getIsoDate(new Date)
      }
    };
    searchEvents(filter).
    then(function (data) {
